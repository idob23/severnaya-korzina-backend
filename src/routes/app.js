...
download_url: 'http://84.201.149.245:3000/downloads/severnaya-korzina-5.1.5.apk',
  ...
  changelog: [
    ...
    '• Разделение товаров на штучные и упаковками',
    '• Кнопка обновления экрана каталога',
    '• Улучшение механизма поиска товаров',
],
